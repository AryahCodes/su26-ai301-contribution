...
The provider must also define the appropriate CLI execution capability,
follow the repository’s provider adapter structure, and include the required
tests.
...
This issue also gives me experience working inside a large TypeScript monorepo
and learning how AI providers are integrated into a real application.
